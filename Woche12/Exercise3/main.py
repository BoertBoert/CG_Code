...
cube_list = []
for i in range(10):
    cube = Cube(random.randint(0,100)/100, glm.vec3(random.randint(0,100)/100,random.randint(0,100)/100,random.randint(0,100)/100))
    cube.translate(glm.vec3(random.randint(0,100)/10 * i, random.randint(0,100)/10 * i, random.randint(0,100)/10 * i))
